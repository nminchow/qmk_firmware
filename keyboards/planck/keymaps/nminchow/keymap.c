 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Brite| Ctrl | Alt  | GUI  |Nums  |    Space    |Funct | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_NUMS] = LAYOUT_planck_grid(
    ...
    _______, KC_F21,  KC_F22,  KC_F23,  _______,  _______, _______, _______,    KC_MINS,    KC_EQL,  KC_UNDS, KC_PLUS
),
...
[_FUNCT] = LAYOUT_planck_grid(
    ...
    _______, KC_LEFT,   KC_DOWN, KC_RGHT,  KC_DELETE, _______, S_IMPER, _______,  _______, KC_LCBR, KC_RCBR, KC_PIPE,
...
uint32_t layer_state_set_user(uint32_t state) {
  return update_tri_layer_state(state, _NUMS, _FUNCT, _ADJUST);
}
